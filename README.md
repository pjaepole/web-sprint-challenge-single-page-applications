...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    gives you information on how Route is matched.
1. How would you explain form validation to someone who has never programmed before?
    Form validation is how we tell computer what information and requirement we need for forms. 
1. In 1-2 sentences, define end to end testing.
    End to end testing is to test the real user scenario and validate system and components work under those situations
## Instructions
...
- [comeback] Validation for name and the error message is "name must be at least 2 characters" (Use this exact error message to make sure tests pass)
- [x] A dropdown for pizza size with an id of "size-dropdown"
- [needToAddCheckedAndOnChange] A checklist for toppings - at least 4 (hint: name each separately!)
